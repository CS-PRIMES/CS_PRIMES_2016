                ...
                for i in range(7):
                    ...
                    if parent != "z" * self.all_graphs_increment:
                        try:
                            ...
                            print "Vertex number: " + str(v)
                            self.all_graphs.seek(self.all_graphs_start + self.all_graphs_increment * 7 * (v-1))
                            print "previous vertex parent 0: " + self.all_graphs.read(self.all_graphs_increment)
                            print "previous vertex parent 1: " + self.all_graphs.read(self.all_graphs_increment)
                            print "previous vertex parent 2: " + self.all_graphs.read(self.all_graphs_increment)
                            print "previous vertex parent 3: " + self.all_graphs.read(self.all_graphs_increment)
                            print "previous vertex parent 4: " + self.all_graphs.read(self.all_graphs_increment)
                            print "previous vertex parent 5: " + self.all_graphs.read(self.all_graphs_increment)
                            print "previous vertex parent 6: " + self.all_graphs.read(self.all_graphs_increment)
                            print "this vertex parent 0: " + self.all_graphs.read(self.all_graphs_increment)
                            print "this vertex parent 1: " + self.all_graphs.read(self.all_graphs_increment)
                            print "this vertex parent 2: " + self.all_graphs.read(self.all_graphs_increment)
                            print "this vertex parent 3: " + self.all_graphs.read(self.all_graphs_increment)
                            print "this vertex parent 4: " + self.all_graphs.read(self.all_graphs_increment)
                            print "this vertex parent 5: " + self.all_graphs.read(self.all_graphs_increment)
                            print "this vertex parent 6: " + self.all_graphs.read(self.all_graphs_increment)
                            print "next vertex parent 0: " + self.all_graphs.read(self.all_graphs_increment)
                            print "next vertex parent 1: " + self.all_graphs.read(self.all_graphs_increment)
                            print "next vertex parent 2: " + self.all_graphs.read(self.all_graphs_increment)
                            print "next vertex parent 3: " + self.all_graphs.read(self.all_graphs_increment)
                            print "next vertex parent 4: " + self.all_graphs.read(self.all_graphs_increment)
                            print "next vertex parent 5: " + self.all_graphs.read(self.all_graphs_increment)
                            print "next vertex parent 6: " + self.all_graphs.read(self.all_graphs_increment)                            
