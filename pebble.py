        ...
        if self.debug:
            ...
            if not self.is_pebbled(v):
                if self.is_source(v):
                    ...
                    self.pebble_value.seek(self.hash_length * self.all_graphs[str(self.graph_num)][v][0])
                    ...
                    self.pebble_value.seek(self.hash_length * self.all_graphs[str(self.graph_num)][v][1])
